...
namespace LagerCore.Logging
{
    public static class Write
    {
        ...
        /// </remarks>
        private static DirectoryInfo _logDir = new DirectoryInfo(System.IO.Directory.GetCurrentDirectory());
        ...
        public static Exception SetLogDir(string logDir, bool createIfNotExisting = false)
        {
            if (string.IsNullOrEmpty(logDir))
                logDir = System.IO.Directory.GetCurrentDirectory();
        ...
        {
            return System.IO.File.Exists(GetFileName(dateTime));
        }
        ...
        public static XDocument GetLogFileAsXml(DateTime dateTime)
        {
            ...
            sb.AppendLine(System.IO.File.ReadAllText(fileName));
            sb.AppendLine("</LogEntries>");
        ...
        private static string GetCaller(int framesToSkip = 0)
        {
            ...
            while (true)
            {
                ...
                if (declaringType != typeof(Write) && --framesToSkip < 0)
                    break;
            }
